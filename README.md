...
![GitHub stars](https://img.shields.io/github/stars/EnderPhantomWing/litematica-printer)
![GitHub release](https://img.shields.io/github/v/release/EnderPhantomWing/litematica-printer)
![Minecraft](https://img.shields.io/badge/Minecraft-1.21%20~%20latest-blue)

> [!WARNING]
> 此`litematica-printer`分支于[BiliXWhite/litematica-printer](https://github.com/BiliXWhite/litematica-printer)  
> 由于原项目提交信息过于混乱，以及提交的大量二进制文件导致`.git`文件夹达到500MB 由此创建这个仓库 顺便学习模组开发

为 [Litematica](https://modrinth.com/mod/litematica) 投影添加自动建造功能的 Minecraft Fabric 模组。支持 1.21.1 ~ latest 版本。

该分支基于[zhaixianyu/litematica-printer](https://github.com/zhaixianyu/litematica-printer) 以及 [BiliXWhite/litematica-printer](https://github.com/BiliXWhite/litematica-printer) 修改，添加了更多实用功能。
...
- [Chest Tracker Port](https://modrinth.com/mod/chest-tracker-port) (≥1.21.4) - 箱子追踪
...
```bash
git clone https://github.com/EnderPhantomWing/litematica-printer.git
...
| Contributors (按照首字母排序)                                               | 贡献描述          |
|----------------------------------------------------------------------|---------------|
| [aleksilassila](https://github.com/aleksilassila/litematica-printer) | 原创打印机         |
| [BiliXWhite](https://github.com/BiliXWhite)                          | 三改打印机作者       |
| [bunny_i](https://github.com/bunnyi116)                              | 三改开发者之一，破基岩支持 |
| [MoRanpcy](https://github.com/MoRanpcy/quickshulker)                 | 快捷潜影盒支持       |
| [zhaixianyu](https://github.com/zhaixianyu/litematica-printer)       | 二改打印机作者       |
